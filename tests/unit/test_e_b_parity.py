...
class TestVectoraContext:
    def test_ctx_from_config_full(self):
        ...
        from src.types.context import ctx_from_config
...
class TestFilesystemPermission:
    def test_deny_env_file(self):
        ...
        from src.services.permissions import FS_PERMISSION
...
class TestMemoryToolsNamespace:
    ...
    def test_memory_namespace_structure(self):
        ...
        from src.tools.memory import _memory_namespace
...
class TestBuildStore:
    ...
    def test_build_store_no_index_when_no_key(self):
        ...
        from src.services.backends import _build_index

        with patch("src.settings.settings") as mock_s:
...
class TestBuildBackend:
    def test_composite_backend_created(self):
        ...
        from src.services.backends import build_backend
...
class TestSubagentSpecs:
    def test_subagent_specs_returns_two(self):
        ...
        from src.services.agent_factory import _subagent_specs
    ...
    def test_subagent_specs_abac_filtering(self):
        ...
        with (
            patch(
                "src.agents.coder.SUBAGENT_SPEC",
                {
                    "name": "coder",
                    "description": "d",
                    "system_prompt": "s",
            ...
            patch(
                "src.agents.search.SUBAGENT_SPEC",
                {
                    "name": "search",
                    "description": "d",
                    "system_prompt": "s",
            ...
            patch("src.services.tool_policy.get_disabled", return_value=["file_write"]),
        ):
...
class TestAgentsMdPaths:
    def test_returns_none_when_no_file(self, tmp_path):
        ...
        from src.services.agent_factory import _agents_md_paths

        with patch("src.services.agent_factory.Path") as mock_path_cls:
            mock_home = MagicMock()
...
class TestLangSmith:
    ...
    def test_enable_sets_env_vars(self):
        ...
        from src.services.tracer import (
    ...
    def test_disable_clears_env_vars(self):
        ...
        from src.services.tracer import disable_langsmith_tracing

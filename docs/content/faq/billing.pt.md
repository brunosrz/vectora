...
Free é 100% local, sem conta. Pro desbloqueia chat web multi-usuário, storage complete (Postgres+Qdrant+Redis) e automações disparadas por webhook — veja [preços atualizados](https://vectora.company/#pricing).

...
- Aprobar una vez: `POST /workspaces/approve-mcp-write` (o el interruptor en **Configuración → Workspace**) libera las 3 herramientas para ese workspace hasta que se revoque.

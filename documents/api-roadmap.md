...
| MCP server                                                                          | `/mcp`, sempre-ativo                      | Já é público — não precisa de trabalho novo, só documentar a relação com o resto da API                                                      |

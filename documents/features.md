...
| Marketplace de skills (fontes múltiplas)            | Hermes, com folga                              | Vectora tem 1 fonte só (catálogo curado); sem versionamento de skill             | Médio                         |
...
| Catálogo de tools nativas                    | ~125 tools, com `toolsets.py` (composição/aliases)                 | **~161 tools**, registry nativo próprio                                 | Vectora em contagem; Hermes em composição                              |
...
| **Versionamento de skill**                   | Sim (`_resolve_latest_version`, download por versão)               | **Não** — só contador de invalidação de cache                           | **Hermes** — pendência nº1 confirmada                                  |
...
1. Versionamento de skill (`package_name`/`version`) — médio esforço (2-3 dias), pendência já conhecida.
...
| Capacidade                                   | Hermes                                                                                | Vectora                                                       | Lidera                                               |
| -------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ---------------------------------------------------- |
| Filesystem compartilhado                     | Alto                                                                                  | Alto                                                          | Empate                                               |
...
| Browser compartilhado                        | Médio (preview de app)                                                                | Médio (escopo parecido, não confirmado se cobre mais)         | Empate                                               |
...
| RAG/memória                                  | Alto (Honcho + skills auto-geradas + FTS5)                                            | Médio (RAG documental)                                        | Hermes — arquiteturas diferentes, não comparável 1:1 |
...
- Catálogo de tools nativas maior em contagem (~161 vs ~125).

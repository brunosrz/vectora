...
`.github/workflows/vectora.yml` cobre CI+CD de ponta a ponta (Jenkins não
é usado neste projeto): lint/security/frontend/build/testes sempre — em
todo PR contra `master` e em todo push em `master` — sem gate manual.

...
class SlashCommandsMixin:
    ...
    async def _cmd_model(self, args: str) -> None:
        from backend.services.runtime_settings import apply_model_change
        from backend.settings import AVAILABLE_MODELS, find_provider_for_model
    ...
    async def _cmd_theme(self, args: str) -> None:
        ...
        from backend.ui.theme import get_theme_css

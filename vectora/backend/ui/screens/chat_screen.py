...
from backend.ui.components import build_popup_options
from backend.ui.components.command_bar import CommandBar
from backend.ui.i18n import t
from backend.ui.slash_handlers import SlashCommandsMixin
...
if TYPE_CHECKING:
    from backend.ui.streaming import StreamHandler
...
class ChatScreen(SlashCommandsMixin, Screen[None]):
    ...
    async def on_mount(self) -> None:
        ...
        from backend.ui.streaming import StreamHandler as _StreamHandler

...
def _apply_global_overrides(args: argparse.Namespace) -> None:
    ...
    if model is not None:
        ...
        from backend.services.runtime_settings import runtime_settings as _rs
...
async def _run_chat_async(args: argparse.Namespace) -> None:
    ...
    if not available_providers:
        ...
        from backend.ui.setup_wizard import run_setup
...
def run() -> None:
    ...
    if command == "server":
        ...
        if mode == "mcp":
            ...
            from backend.mcp.server import run as mcp_run

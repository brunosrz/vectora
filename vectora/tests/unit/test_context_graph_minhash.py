...
class TestMinHashLSH:
    def test_insert_and_query_identical(self):
        from backend.services.context_graph._minhash import MinHash, MinHashLSH
...
class TestOptimalLSHParams:
    def test_returns_valid_bands_rows(self):
        from backend.services.context_graph._minhash import _optimal_lsh_params
...
class TestLSHIntegrate:
    def test_constant_function(self):
        from backend.services.context_graph._minhash import _lsh_integrate

...
class TestParallelDispatch:
    ...
    async def test_uses_agent_specific_prompt(self):
        ...
        from backend.agents.orchestrator import _PARALLEL_AGENT_PROMPTS
        from backend.nodes.parallel import parallel_dispatch
...
class TestOrchestratorParallelRouting:
    def test_parallel_maps_to_parallel_dispatch(self):
        ...
        from backend.agents.orchestrator import _orchestrator_route
...
class TestSubTaskModel:
    def test_subtask_creation(self):
        ...
        from backend.types import SubTask
    ...
    def test_orchestrator_decision_accepts_parallel(self):
        ...
        from backend.types import OrchestratorDecision, SubTask
    ...
    def test_orchestrator_decision_parallel_tasks_none_by_default(self):
        ...
        from backend.types import OrchestratorDecision

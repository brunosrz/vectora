...
class TestUpdateProfile:
    ...
    async def test_updates_name(self):
        from backend.services.auth import signup, update_profile
    ...
    async def test_raises_for_unknown_user(self):
        from backend.services.auth import update_profile
    ...
    async def test_persists_across_get_user_by_id(self):
        ...
        from backend.services.auth import get_user_by_id, signup, update_profile

...
class TestHITLEventSchema:
    ...
    def test_hitl_event_encode_has_type_hitl(self) -> None:
        from backend.api.schemas import HITLEvent, encode_event
    ...
    def test_hitl_event_in_stream_payload_union(self) -> None:
        from backend.api.schemas import HITLEvent, StreamChatEventPayload
...
class TestGetInterruptOn:
    def test_ask_mode_interrupts_all_destructive(self) -> None:
        ...
        from backend.graph import REQUIRE_APPROVAL, get_interrupt_on
    ...
    def test_bypass_mode_returns_empty(self) -> None:
        ...
        from backend.graph import get_interrupt_on
    ...
    def test_accept_edits_excludes_file_write(self) -> None:
        ...
        from backend.graph import ACCEPT_EDITS_AUTO, get_interrupt_on

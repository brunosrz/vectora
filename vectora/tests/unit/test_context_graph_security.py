...
class TestIpIsBlocked:
    def test_loopback_is_blocked(self):
        from backend.services.context_graph.security import _ip_is_blocked
...
class TestValidateUrl:
    def test_http_allowed(self):
        from backend.services.context_graph.security import validate_url
...
class TestCheckGraphFileSizeCap:
    def test_small_file_passes(self, tmp_path: Path):
        from backend.services.context_graph.security import check_graph_file_size_cap
    ...
    def test_oversized_file_raises(
        ...
        from backend.services.context_graph import security
...
class TestSanitizeLabel:
    def test_none_returns_empty(self):
        from backend.services.context_graph.security import sanitize_label
...
class TestSanitizeMetadata:
    def test_none_returns_empty(self):
        from backend.services.context_graph.security import sanitize_metadata

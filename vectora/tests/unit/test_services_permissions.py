...
class TestRoleLevel:
    def test_hierarchy_order(self):
        from backend.services.permissions import role_level
...
class TestHasMinRole:
    ...
    def test_role_comparisons(self, user_role, min_role, expected):
        from backend.services.permissions import has_min_role
...
class TestCanAccessThread:
    def test_root_accesses_any_thread(self):
        from backend.services.permissions import can_access_thread
...
class TestCanDeleteThread:
    def test_admin_deletes_any(self):
        from backend.services.permissions import can_delete_thread
...
class TestCanRunTerminal:
    def test_root_runs_anywhere(self):
        from backend.services.permissions import can_run_terminal
...
class TestAuditAndUserManagement:
    ...
    def test_can_read_audit(self, role, expected):
        from backend.services.permissions import can_read_audit
    ...
    def test_can_manage_users(self, role, expected):
        from backend.services.permissions import can_manage_users

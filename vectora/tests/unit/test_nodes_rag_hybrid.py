...
class TestCallVectorSearchAllHybrid:
    ...
    async def test_hybrid_enabled_applies_rrf(self):
        ...
        from backend.nodes.rag_subgraph import _call_vector_search_all
        ...
        with (
            ...
            patch(
                "backend.nodes.rag_subgraph._call_vector_search",
...
class TestRagExpandQuery:
    ...
    async def test_single_variant_returns_empty(self):
        ...
        with (
            patch("backend.nodes.rag_subgraph.settings") as ms,
            patch(
                "backend.nodes.rag_subgraph._generate_query_variants",
                new_callable=AsyncMock,
...
class TestRagRetrieveHyDE:
    ...
    async def test_hyde_triggered_when_score_low(self):
        ...
        from backend.nodes.rag_subgraph import rag_retrieve
        ...
        with (
            ...
            patch(
                "backend.nodes.rag_subgraph._hyde_search",
                new_callable=AsyncMock,

...
export const Sidebar = memo(function Sidebar({
  ...
  if (isCollapsed) {
    ...
    // Desktop: barra de 64px com botão de expandir + atalhos comprimidos
    // (novo chat e sessões recentes), no estilo do ChatGPT — o conteúdo
    // fica comprimido, não escondido.
    return (

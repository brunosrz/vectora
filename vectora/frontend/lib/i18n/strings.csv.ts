...
workbench.preview.ask_agent_prompt,"Detect my project's dev servers and save all their configurations to .vectora/launch.json, then ask which ones to start.","Detecta los servidores de desarrollo de mi proyecto y guarda todas sus configuraciones en .vectora/launch.json, luego pregunta cuáles iniciar.","Detecte os servidores de desenvolvimento do meu projeto e salve todas as configurações em .vectora/launch.json, depois pergunte quais iniciar."
workbench.preview.ask_agent_note,"Use runtimeExecutable for the command (e.g. ""yarn"", ""npm"", ""node"", ""python"") and runtimeArgs for its arguments. Once saved, start each server from the Preview panel.","Usa runtimeExecutable para el comando (ej. ""yarn"", ""npm"", ""node"", ""python"") y runtimeArgs para sus argumentos. Una vez guardado, inicia cada servidor desde el panel de Preview.","Use runtimeExecutable para o comando (ex. ""yarn"", ""npm"", ""node"", ""python"") e runtimeArgs para os argumentos. Após salvar, inicie cada servidor pelo painel de Preview."

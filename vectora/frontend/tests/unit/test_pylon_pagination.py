...
class TestFetchAllArticlesPagination(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import backend.tools.pylon_tools as pylon_module
    ...
    @patch("backend.tools.pylon_tools._get_api_key", return_value="fake-key")
    @patch("backend.tools.pylon_tools._get_kb_id", return_value="kb-123")
    @patch("backend.tools.pylon_tools.requests.get")

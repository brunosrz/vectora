...
export function VoiceInputButton({ isListening, disabled, onClick, size = "sm" }: VoiceInputButtonProps) {
  ...
  return (
    ...
    >
      {isListening ? <StopIcon className={iconSize} /> : <MicrophoneIcon className={iconSize} />}
    </Button>
  );
}

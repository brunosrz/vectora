...
async def chat_loop(
    ...
    from src.ui.commands import _load_debug_config
...
async def run_chat(
    ...
    *,
    ...
    async with async_lifespan():
        ...
        from src.services.workspace import workspace_registry as _ws_registry

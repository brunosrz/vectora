...
from src.ui.commands._shared import AVAILABLE_MODELS, get_available_models
from src.ui.commands.debug import (
    handle_debug_command,
    load_debug_config,
    save_debug_config,
)
from src.ui.commands.help import (
    display_command_list,
    display_help,
    handle_tools_command,
)
from src.ui.commands.model import handle_model_command
from src.ui.commands.rag import handle_rag_command
from src.ui.commands.session import (
    handle_list_sessions,
    handle_new_session,
    handle_switch_session,
)
from src.ui.commands.traces import handle_traces_command
from src.ui.commands.workspaces import handle_workspaces_command

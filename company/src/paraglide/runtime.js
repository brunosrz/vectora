 ...
 */
export const strategy = ['url', 'cookie', 'baseLocale']
/**
...
export function generateStaticLocalizedUrls(urls) {
  ...
  for (const urlInput of urls) {
    const url =
      urlInput instanceof URL ? urlInput : new URL(urlInput, 'http://localhost')
